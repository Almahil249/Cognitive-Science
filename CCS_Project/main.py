...
def train(pop_size=10,iteration = 11,mutat_rate=0.1,crossover_rate=0.7):
    ...
    with open(output_file, 'w') as f:
            for i in range(1, iteration):
                ...
                for chromo in G.popultion:
                    game_score = game.main(chromo, 3000, 200000,i,weight_idnex)
                    ...
                    if(best_gen_score < game_score[2]):
                        ...
                        best_weight = chromo
                    elif(snd_best_gen_score < game_score[2]):
